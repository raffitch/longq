...
const PatientDashboard: React.FC<PatientDashboardProps> = ({ clientFullName, reportDate, aggregated, isPreview }) => {
  const {
    categories,
    nutrition,
    heavyMetals,
      ...
      <main className="mx-auto flex max-w-[1440px] flex-col gap-12 px-4 pb-24 pt-10 md:px-8 lg:px-12">
        <header className="flex flex-col gap-8">
          <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
            <h1 className="text-5xl font-bold text-text-primary md:text-7xl lg:text-8xl">Quantum Qi</h1>
          ...
          <div className="flex flex-col gap-4 rounded-2xl bg-bg-card p-6 text-text-secondary md:flex-row md:items-center md:gap-12 lg:gap-18">
            <div className="flex flex-col">
              <span className="text-xl md:text-2xl">Patient Name</span>
