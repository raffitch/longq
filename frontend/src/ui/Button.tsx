...
const variantClasses: Record<string, string> = {
  primary:
    "bg-accent text-white hover:scale-[1.01] active:scale-[0.99] disabled:bg-[#4b5563] disabled:text-white disabled:opacity-100",
  ...
  ghost:
    "border border-border bg-transparent text-text-primary hover:border-border-strong hover:bg-surface-muted",
